...
void main()
{
	...
	char fs[] = 
		...
		"float vignette = 1.0 - length(vt - vignetteCenter) * 1.45; \n"
		"color *= d * vec3( dmw.x, dmw.y, dmw.z ) * vignette;	\n"			// Apply vignette effect by multiplying the colour by it.
